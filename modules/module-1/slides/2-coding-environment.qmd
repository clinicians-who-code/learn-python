...
## Today's hands-on sessions {background-image="/images/bamboo-woods.jpg" background-opacity="0.2"}
...
![](/images/the-shell.png){.bordered fig-align="center" width="max" height="max"}

## Commands {background-image="/images/command-button.jpg" background-opacity="0.2"}
...
![](/images/command-ls.png){.bordered fig-align="center" width="max" height="max"}
...
![](/images/command-cd.png){.bordered fig-align="center" width="max" height="max"}

## Where am I?

* `pwd` is the `print working directory` command.

![](/images/command-pwd.png){.bordered fig-align="center" width="max" height="max"}


# Time to try it out for yourself{background-image="/images/dive-into-lake.jpg" background-opacity="0.2"}
...
![](/images/liveshare.png){width="max" fig-align="center" height="max" border-width="1"}

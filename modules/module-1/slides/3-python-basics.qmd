...
## What are computers? {background-image="/images/yes-no-hands.jpg" background-opacity="0.3"}
...
## Translation {background-image="/images/keyboard-of-flags.jpg" background-opacity="0.2"}
...
# <span style="font-size: smaller;">OK, so you can write some code. What do you put in the code? How do you tell the computer what to do?</span> {background-image="/images/barren-land.jpg" background-opacity="0.4"}


## We will be learning python

![](/images/python-logo.png){fig-align="center"}

## The Python programming language{background-image="/images/python-logo.png" background-opacity="0.3"}
...
## Indentation {background-image="/images/steps-and-child.jpg" background-opacity="0.4"}
...
## Basic operators {background-image="/images/blackboard-and-equations.jpg" background-opacity="0.2"}
...
## More advanced operators {background-image="/images/blackboard-and-equations.jpg" background-opacity="0.2"}
...
# <span style="font-size: smaller;">OK, so you can create variables, change them and compare them. What next?</span> {background-image="/images/river-close-up.jpg" background-opacity="0.4"}
...
## Functions (methods) {background-image="/images/box.jpg" background-opacity="0.4"}
...
## Error Handling {background-image="/images/insect-on-leaf.jpg" background-opacity="0.3"}
...
## You got all that? {background-image="/images/coding.jpg" background-opacity="0.3"}
